...
void Vlj12a3_proximity_driver_tb___024root___eval_triggers__act(Vlj12a3_proximity_driver_tb___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vlj12a3_proximity_driver_tb___024root___eval_triggers__act\n"); );
    // Body
    vlSelf->__VactTriggered.set(0U, (((IData)(vlSelf->lj12a3_proximity_driver_tb__DOT__clk) 
                                      & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__lj12a3_proximity_driver_tb__DOT__clk__0))) 
                                     | ((~ (IData)(vlSelf->lj12a3_proximity_driver_tb__DOT__rst_n)) 
                                        & (IData)(vlSelf->__Vtrigprevexpr___TOP__lj12a3_proximity_driver_tb__DOT__rst_n__0))));
    vlSelf->__VactTriggered.set(1U, ((IData)(vlSelf->lj12a3_proximity_driver_tb__DOT__clk) 
                                     & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__lj12a3_proximity_driver_tb__DOT__clk__0))));
