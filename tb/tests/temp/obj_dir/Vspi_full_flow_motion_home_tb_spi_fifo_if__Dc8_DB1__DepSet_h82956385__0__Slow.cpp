...
VL_ATTR_COLD void Vspi_full_flow_motion_home_tb_spi_fifo_if__Dc8_DB1___ctor_var_reset(Vspi_full_flow_motion_home_tb_spi_fifo_if__Dc8_DB1* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vspi_full_flow_motion_home_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vspi_full_flow_motion_home_tb_spi_fifo_if__Dc8_DB1___ctor_var_reset\n"); );
    // Body
