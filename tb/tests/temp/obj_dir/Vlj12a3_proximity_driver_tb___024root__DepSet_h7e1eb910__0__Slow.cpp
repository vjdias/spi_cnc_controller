...
VL_ATTR_COLD void Vlj12a3_proximity_driver_tb___024root___ctor_var_reset(Vlj12a3_proximity_driver_tb___024root* vlSelf) {
    ...
    vlSelf->lj12a3_proximity_driver_tb__DOT__u_pnp_no__DOT__debounced_q = VL_RAND_RESET_I(1);
    ...
    vlSelf->lj12a3_proximity_driver_tb__DOT__u_npn_no__DOT__debounced_q = VL_RAND_RESET_I(1);
    ...
    vlSelf->lj12a3_proximity_driver_tb__DOT__u_npn_nc__DOT__debounced_q = VL_RAND_RESET_I(1);
    ...
    vlSelf->lj12a3_proximity_driver_tb__DOT__u_pnp_nc__DOT__debounced_q = VL_RAND_RESET_I(1);
    ...
    vlSelf->lj12a3_proximity_driver_tb__DOT__u_db__DOT__debounced_q = VL_RAND_RESET_I(1);
