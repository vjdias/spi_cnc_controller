...
VL_ATTR_COLD void Vspi_full_flow_tick_count_tb_spi_fifo_if___ctor_var_reset(Vspi_full_flow_tick_count_tb_spi_fifo_if* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vspi_full_flow_tick_count_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vspi_full_flow_tick_count_tb_spi_fifo_if___ctor_var_reset\n"); );
    // Body
